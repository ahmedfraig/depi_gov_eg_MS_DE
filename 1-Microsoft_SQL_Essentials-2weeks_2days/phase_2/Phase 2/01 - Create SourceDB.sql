...
EXEC
('IF NOT EXISTS (SELECT * FROM sys.tables WHERE name=''Source.Departments'')
BEGIN
...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name=''Source.Employees'')
BEGIN
...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name=''Source.Projects'')
BEGIN
...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name=''Source.Assignments'')
BEGIN
